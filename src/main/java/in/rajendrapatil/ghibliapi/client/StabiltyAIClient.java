...
@FeignClient(name = "stabilityAiClient", url = "${stability.api.base-url}", configuration = in.rajendrapatil.ghibliapi.config.FeignConfig.class)
public interface StabiltyAIClient {

      @PostMapping(value="/v1/generation/{engine_id}/text-to-image",
